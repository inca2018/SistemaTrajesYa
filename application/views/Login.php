        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" novalidate="" autocomplete="off" action="Login/logeo" method="post">

                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12 text-center">
                                        <img src="<?php echo base_url(); ?>\assets\images\logo_sinFondo.png" width="100%">
                                    </div>
                                </div>
                                <div class="form-group form-primary">
                                    <input type="text" class="form-control" required="" placeholder="Tu Usuario" id="usuario" name="L_User" required>
                                    <span class="form-bar"></span>
                                    <label id="mensajeUsu"></label>
                                </div>
                                <div class="form-group form-primary">
                                    <input type="password" class="form-control" required="" placeholder="Tu Contraseña" id="password" name="L_Password" required>
                                    <span class="form-bar"></span>
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-warning btn-md btn-block waves-effect waves-light text-center m-b-20">Ingresar</button>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <p class="text-inverse text-center"><a href="javascript:void(0)"><b class="f-w-600">Empresa 2019</b></a></p>
                                    </div>
