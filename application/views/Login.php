                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" novalidate="" autocomplete="off" action="Login/logeo" method="post">
                            <div class="text-center">
                                <img src="<?php echo base_url(); ?>\assets\images\logo2.png" width="20%"> 
                            </div> 
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h5 class="text-center">Sistema de Registro de Horas</h5>
                                        </div> 
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <p class="text-inverse text-center"><a href="javascript:void(0)"><b class="f-w-600">Qsystem Sac 2019</b></a></p>
                                        </div>
