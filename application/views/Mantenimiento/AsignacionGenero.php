                ...
                <div class="page-body">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#">Asignación de Generos</a> </li>
                                </ul>
                            </div>
                        ...
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h6 class="m-b-20 p-b-5 b-b-default f-w-600">Asignación de Generos Disponibles:</h6>
                                </div>
                                ...
                                <div class="col-6 text-center">
                                    <h4 class="">Generos no Asignadas</h4>
                                </div>
                                <div class="col-6 text-center">
                                    <h4 class="">Generos Asignadas</h4>
                                </div>
                                <div class="col-12">
                                    <select id='selectGeneros' class="buscadorGenero" multiple='multiple'>
                                    </select>
                                </div>
                            </div>
                        </div>
...
?>
<script type="text/javascript" src="<?php echo base_url();?>assets/js/Mantenimiento/AsignacionGenero.js"></script>
