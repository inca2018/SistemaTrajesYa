...
<input class="btn btn-danger" type="hidden" id="notify_danger" data-message="Message with status.." data-options="{&quot;status&quot;:&quot;danger&quot;, &quot;pos&quot;:&quot;bottom-right&quot;}">

<input class="btn btn-info" type="hidden" id="notify_info" data-message="Message with status.." data-options="{&quot;status&quot;:&quot;info&quot;, &quot;pos&quot;:&quot;bottom-right&quot;}" Info>

<input class="btn btn-warning" type="hidden" id="notify_warning" data-message="Message with status.." data-options="{&quot;status&quot;:&quot;warning&quot;, &quot;pos&quot;:&quot;bottom-right&quot;}">
...
<script type="text/javascript" src="<?php echo base_url(); ?>\files\bower_components\bootstrap-datepicker\js\bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>\files\assets\pages\advance-elements\bootstrap-datetimepicker.min.js"></script>
<!-- Date-range picker js -->
<script type="text/javascript" src="<?php echo base_url(); ?>\files\bower_components\bootstrap-daterangepicker\js\daterangepicker.js"></script>
<!-- Date-dropper js -->
<script type="text/javascript" src="<?php echo base_url(); ?>\files\bower_components\datedropper\js\datedropper.min.js"></script>
<!-- Color picker js -->
<script type="text/javascript" src="<?php echo base_url(); ?>\files\bower_components\spectrum\js\spectrum.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>\files\bower_components\jscolor\js\jscolor.js"></script>
<!-- Mini-color js -->
<script type="text/javascript" src="<?php echo base_url(); ?>\files\bower_components\jquery-minicolors\js\jquery.minicolors.min.js"></script>
...
<!-- Custom js  PICKER-->
<script type="text/javascript" src="<?php echo base_url(); ?>\files\assets\pages\advance-elements\custom-picker.js"></script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>\files\assets\js\jquery.quicksearch.js"></script>
...
<!-- data-table-spanish js -->
<script src="<?php echo base_url(); ?>\assets\vendor\dataespanish.js"></script>
<!-- notification js -->
<script type="text/javascript" src="<?php echo base_url(); ?>\files\assets\js\bootstrap-growl.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>\files\assets\pages\notification\notification.js"></script>
<!-- sweetalert -->
